...
import { Mail, Lock, User, Eye, EyeOff, ArrowLeft, MailCheck, ArrowRight } from 'lucide-react'
...
const btnPrimary =
  'w-full rounded-xl bg-olive-900 py-4 text-[0.92rem] font-medium text-paper transition-all duration-300 hover:bg-olive-800 hover:shadow-lg hover:shadow-olive-900/20 cursor-pointer'
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80svh] bg-[#f4f1eb] flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px]">
          {/* <Link to="/" className="inline-flex items-center gap-2 text-sm text-olive-700/60 hover:text-olive-900 transition-colors mb-10">
            <ArrowLeft size={16} />
            Back to store
          </Link> */}
          ...
          {isSent && (
            <div className="mt-10 space-y-4">
              <div className="grid h-16 w-16 place-items-center rounded-2xl bg-olive-100 text-olive-800 mx-auto">
                ...
                {isRegister && (
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="relative">
                      ...
                      <input type="text" placeholder="First name" autoComplete="given-name" className={inputCls} />
                    </div>
                    <div className="relative">
                      <User size={17} className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-olive-700/40" />
                      <input type="text" placeholder="Last name" autoComplete="family-name" className={inputCls} />
                    </div>
                  </div>
                )}
